...
(function () {
    ...
    function node_click(event) {
        if ($('#sitemapVariableOption').is(':checked')) {
            $axure.page.navigate(this.getAttribute('nodeUrl'));
        } else {
            //Use getLinkUrlWithVars function in axprototype.js to get the url with the
            //currently set global variables appended
            var linkUrl = $axure.getLinkUrlWithVars(this.getAttribute('nodeUrl'));
            $axure.page.navigate(linkUrl);
        }
    }
